...
data class ConfigureData(
    ...
    val isShowNavBarsInFullScreen: Boolean = true,
    ...
    fun toJson(): String {
        return JSONObject().apply {
            ...
            put(KEY_IS_SHOW_NAV_BARS_IN_FULLSCREEN,isShowNavBarsInFullScreen)
    ...
    companion object {
        ...
        private const val KEY_IS_SHOW_NAV_BARS_IN_FULLSCREEN = "key_is_show_nav_bars_in_fullscreen"
        ...
        fun fromJson(jsonString: String): ConfigureData {
            ...
            return ConfigureData(
                ...
                isShowNavBarsInFullScreen = jsonObject.optBoolean(KEY_IS_SHOW_NAV_BARS_IN_FULLSCREEN, true),
